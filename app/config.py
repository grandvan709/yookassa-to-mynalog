...
TELEGRAM_RECEIPT_REPORT_CHAT_ID = os.getenv("TELEGRAM_RECEIPT_REPORT_CHAT_ID")
TELEGRAM_RECEIPT_REPORT_THREAD_ID = os.getenv("TELEGRAM_RECEIPT_REPORT_THREAD_ID")
