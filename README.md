...
Доступ проверяется одновременно по `TELEGRAM_CHAT_ID` и
`TELEGRAM_ADMIN_USER_ID`. Это важно для групп: другой участник разрешённого
чата не сможет выполнить административную команду.
...
| `🔔 Уведомления` | Включать и выключать успешные чеки и ошибки отдельными кнопками |
...
«Успешные чеки: ВКЛ/ВЫКЛ» и другие. Создание backup требует отдельного
